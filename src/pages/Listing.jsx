...
export default function Listing() {
  ...
  return (
    <main>
      ...
      {shareLinkCopied && (
        <p className="fixed top-[23%] right-[5%] font-semibold border-2 border-gray-400 rounded-md bg-white z-10 p-1 text-slate-600">
          Link Copied!
        </p>
      )}
      ...
      <div className="m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg  shadow-lg bg-white lg:space-x-5">
          ...
          {listing.userRef !== auth.currentUser?.uid && !contactLandlord && (
            <div className="mt-6">
              <button
                ...
                className="px-7 py-3 bg-blue-600 text-white uppercase font-semibold text-sm rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg w-full text-center transition duration-150 ease-in-out"
              >
                Contact Landlord
              </button>
            </div>
        ...
        <div className=" w-full h-[200px] md:h-[400px] md:ml-2 z-10 overflow-x-hidden mt-6 lg:mt-0 ">
          <MapContainer
