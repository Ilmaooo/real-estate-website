...
export default function SignUp() {
  ...
  return (
    <section>
      <h1 className="text-3xl text-center mt-6 font-bold text-blue-700">
        Sign Up
      </h1>
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form onSubmit={onSubmit}>
            <input
              className="w-full mb-6 px-4 py-2text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out"
              type="text"
              id="name"
              value={name}
              onChange={onChange}
            ...
            <div className="relative mb-6">
              <input
                className="w-full px-4 py-2text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out"
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out shadow-lg active:bg-blue-800"
            >
              Sign up
            </button>
